...
//        DismissDirection.StartToEnd -> androidx.compose.ui.graphics.Color.Red
//    }
//}
...
fun QuoteCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(text = quote.body, modifier = Modifier.align(Alignment.Start))
        ...
        confirmValueChange = {
            when(it){
                SwipeToDismissBoxValue.EndToStart ->{
                    ...
                    Toast.makeText(context, "Quote deleted from favorites", Toast.LENGTH_SHORT).show()
                    true
                }
                else -> false
            }
