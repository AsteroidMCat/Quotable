                    ...
                    NavHost(
                        ...
                        modifier = Modifier.padding(innerPadding),
                            ...
                            composable<Routes.Home> {
                                Home(quotesListViewModel::getQuoteList,
...
@Composable
fun Home(getQuotesList: () -> List<Quote>, deleteQuote: (Quote) -> Unit, toggleFavoriteQuote: (Quote) -> Unit, modifier: Modifier) {
        QuoteListScreen(getQuotesList,
                        deleteQuote,
                        toggleFavoriteQuote,
                        modifier)
}
...
@Composable
fun Favorites(getFavoriteQuotes: () -> List<Quote>,
              removeFavoriteQuote: (Quote) -> Unit,
              toggleFavoriteQuote: (Quote) -> Unit,
              modifier: Modifier) {
    FavoriteQuotesScreen(getFavoriteQuotes,removeFavoriteQuote, toggleFavoriteQuote, modifier)
}
